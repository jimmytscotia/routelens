...
COMPANIES = [
    ...
    {"name": "Amazon Web Services", "category": "Cloud & infrastructure", "asns": [16509, 14618],
     "status": None},
    {"name": "Microsoft", "category": "Cloud & infrastructure", "asns": [8075], "status": None},
    {"name": "Apple", "category": "Cloud & infrastructure", "asns": [714, 6185], "status": None},
    ...
    # ---- Consumer & social ----
    {"name": "Meta", "category": "Consumer & social", "asns": [32934], "status": None},
